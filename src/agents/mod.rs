...
//!   Assets Manager and Data Analyst, Optimizer, Process Agent)
//! - [`AssetsManagerDataAnalystAgent`] - Maintains auditable external asset/source
//!   records for photos, media, spreadsheets, PDFs, and API links

pub mod assets_manager_agent;
pub mod architect_agent;
pub mod loop_agent;
pub mod prd_agent;
pub mod role_prompts;

pub use assets_manager_agent::{AssetLibrary, AssetRecord, AssetsManagerDataAnalystAgent};
